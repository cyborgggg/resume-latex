...
\vspace{-10pt}
    \resumeProjectSubHeadingListStart
      \resumeProjectHeading
          {\href{https://github.com/noor12401/Content-Management-System-Telegraph}{\color{blue}\textbf{Content Management System - Telegraph}} $|$ \emph{MERN Stack, NextJS, Sendgrid, Cloudinary}}{August 2022}
          \resumeItemListStart
          \resumeProjectItem {Developed a Content Management System using {\color{blue}MERN}}Stack with Admin, Author and Subscriber roles.}
          \resumeProjectItem{Built the \textbf{Admin} page with all access, whereas \textbf{Author} role has limited access, and all roles have their dashboard.}
          \resumeProjectItem{Implemented End-to-End route protection and password hashing with redirection feature.}
          \resumeItemListEnd
          \vspace{-12pt}
          \resumeProjectSubHeadingListStart
    \resumeProjectSubHeadingListStart
...
\section{Certifications}
  \resumeItemListStart
  \item \textbf{\href{}{Certificate Program in JavaScript Full Stack (MERN)}}
  \hfill
  \textbf{StackRoute}
  \vspace{-8pt}
...
\section{Skills}
    \resumeItemListStart
    \item \textbf{Tools/Frameworks}{: NodeJS, Express, Pandas, NumPy, Scikit-learn, Jupyter notebook, Flask, Git}
    \vspace{-8pt}
    \item \textbf{Languages}{: Python, SQL, JavaScript, ReactJS, MongoDB, MATLAB, HTML, CSS, \LaTeX}
    \vspace{-8pt}
    \item \textbf{Interests}{: Full Stack, Machine Learning, Data Structures and Algorithms, Deep Learning, Data Science}
